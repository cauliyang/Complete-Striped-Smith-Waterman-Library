#!/usr/bin/env python3
"""Gene pyi for cpp binding.

@source: https://github.com/robotpy/robotpy-build/blob/main/robotpy_build/command/build_pyi.py
@detail: https://github.com/pybind/pybind11/issues/2350
@version: 0.0.1
"""
