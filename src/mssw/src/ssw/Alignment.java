...
public class Alignment {
  ...
  /**
   * 0-based best alignment beginning position on reference;	ref_begin1 = -1
  ...
  /**
   * 0-based best alignment beginning position on read; read_begin1 = -1 when
   the best alignment beginning position is not available
   */
  ...
  public Alignment(short score1, short score2, int ref_begin1, int ref_end1, int read_begin1,
      int read_end1, int ref_end2, String cigar) {
    this.score1 = score1;
    this.score2 = score2;
  ...
  public String toString() {
    return String.format("score1=%d score2=%d, ref=%d,%d read=%d,%d refend2=%d, cigar=%s", score1,
        score2, ref_begin1, ref_end1, read_begin1, read_end1, ref_end2, cigar);
  }
}
