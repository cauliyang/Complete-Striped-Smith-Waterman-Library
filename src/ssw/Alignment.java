...
public class Alignment {
  ...
  public Alignment(short score1, short score2, int ref_begin1, int ref_end1,
                   int read_begin1, int read_end1, int ref_end2, String cigar) {
    this.score1 = score1;
    this.score2 = score2;
  ...
  public String toString() {
    return String.format(
        "score1=%d score2=%d, ref=%d,%d read=%d,%d refend2=%d, cigar=%s",
